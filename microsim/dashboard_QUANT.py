...
def create_dashboard(parameters_file):
    ...
    quant_dir = os.path.join(data_dir,"QUANT_RAMP","model-runs")
    ...
    if nr_scenarios <= 2:
        ...
        # merge
        primaryschools = pd.merge(primar_schools, dangers_dict["PrimarySchool"], left_index=True, right_index=True)
